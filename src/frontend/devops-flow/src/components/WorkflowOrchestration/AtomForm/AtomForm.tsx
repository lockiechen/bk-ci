...
// 动态导入组件
const VuexInput = defineAsyncComponent(() => import('./components/VuexInput'))
const VuexTextarea = defineAsyncComponent(() => import('./components/VuexTextarea'))
const Selector = defineAsyncComponent(() => import('./components/Selector'))
const AtomCheckbox = defineAsyncComponent(() => import('./components/AtomCheckbox'))
const EnumInput = defineAsyncComponent(() => import('./components/EnumInput'))
const KeyValueMap = defineAsyncComponent(() => import('./components/KeyValueMap'))
const AtomAceEditor = defineAsyncComponent(() => import('./components/AtomAceEditor'))
const AtomCheckboxList = defineAsyncComponent(() => import('./components/AtomCheckboxList'))
const StaffInput = defineAsyncComponent(() => import('./components/StaffInput'))
const AtomDatePicker = defineAsyncComponent(() => import('./components/AtomDatePicker'))
  ...
  setup(props, { emit }) {
    ...
    const isHidden = (obj: any, element: any) => {
      try {
        ...
        // 处理字符串形式的函数 (devops-pipeline 中常见的模式)
