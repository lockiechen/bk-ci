...
Module.prototype.require = function(id) {
  ...
  if (id === 'vue' || id.endsWith('/vue') || (id.includes('vue') && !id.includes('vue-template-compiler') && !id.includes('@vue/compiler'))) {
  ...
  if (id.includes('@vue/compiler-sfc') || id.includes('@vue/compiler-dom') || id.includes('@vue/compiler-core')) {
